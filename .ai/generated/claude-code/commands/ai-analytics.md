---
description: Workflow ANALYTICS — Аналитика функции — метрики, события, tracking plan, dashboard-спецификация.
---
...
## Blocking gates
intake_completeness, analytics_readiness, event_contract_consistency, implementation_verification
